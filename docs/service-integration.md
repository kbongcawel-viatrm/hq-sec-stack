...
Incidents flow from Wazuh/Graylog alerts into TheHive cases. Shuffle now runs as split frontend, backend, and Orborus containers; it calls TheHive, Velociraptor, Graylog, Wazuh, or Ansible playbooks for response automation. Velociraptor handles endpoint hunts and collection; Ansible handles repeatable containment and hardening tasks.
